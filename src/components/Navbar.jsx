        ...
        >
          <div className="px-4 py-6 max-h-[80vh] overflow-y-auto">
            ...
            <div className="pt-6 mt-3 border-t border-gray-100">
              <Link
                to="/contact"
                className="relative group inline-flex items-center justify-center gap-2 bg-gray-900 text-white px-6 py-4 rounded-full text-sm font-medium overflow-hidden transition-all duration-500 hover:shadow-[0_0_15px_rgba(223,145,20,0.5)]"
                onClick={() => setIsOpen(false)}
              >
                <span className="relative z-10 font-semibold tracking-wide">Free Consultation</span>
